...
export default function UserSettingsPage() {
  ...
  const goToActivityLogs = () => router.push("/activity");
  const goToUpdateInfo = () => router.push("/update-info");
  const goToChangePassword = () => router.push("/update-password");

  return (
    <div className="flex min-h-screen bg-[var(--bg)] text-[var(--text)] overflow-x-hidden">
      {/* Desktop Sidebar */}
      <div className="hidden md:block">
        <Sidebar onToggle={setSidebarExpanded} expanded={sidebarExpanded} />
      </div>
      ...
      {/* Main Content */}
      <main
        className={`transition-all duration-300 flex-1 p-4 md:p-6 mt-12 md:mt-0 ${
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="card p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <button className="btn-primary w-full" onClick={goToUpdateInfo}>
              Update Information
            </button>
          </div>
          ...
          <div className="card p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <button className="btn-primary w-full" onClick={goToChangePassword}>
              Change Password
            </button>
          </div>
          ...
          <div className="card p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <button className="btn-primary w-full" onClick={goToActivityLogs}>
              View Activity Logs
            </button>
          </div>
        </div>
