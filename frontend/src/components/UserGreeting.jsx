...
export default function UserGreeting({ username, title, subtitle }) {
  return (
    <div className="user-greeting sticky top-0 z-10 bg-[var(--bg)] text-[var(--text)] border-b border-gray-200 dark:border-gray-700 px-8 py-4 flex items-center justify-between">
      <div>
